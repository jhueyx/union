...
const PRIMARY_BTN =
  'inline-flex items-center justify-center rounded-[2px] text-xs font-medium tracking-[0.18em] uppercase px-7 py-3 bg-zinc-900 text-zinc-50 transition-all duration-200 ease-out hover:-translate-y-0.5 hover:shadow-md active:translate-y-0'
const SECONDARY_BTN =
...
export default function Invitation() {
  return (
    <div className="max-w-[700px] mx-auto px-6 py-20 md:py-28 text-center">
      ...
      <h1
        className="text-5xl md:text-7xl text-zinc-900 mb-10"
        style={{ fontFamily: "'Great Vibes', cursive", lineHeight: 1.1 }}
      >
        Sally &amp; Jason
      </h1>

      <p className="text-sm md:text-base leading-[1.9] text-zinc-500 max-w-[520px] mx-auto mb-12">
        Together with their families, request the honour of your presence at the
        celebration of their marriage.
      </p>

      <div className="w-10 h-px bg-zinc-200 mx-auto mb-12"aria-hidden="true"/>
