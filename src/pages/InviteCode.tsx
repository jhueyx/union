...
export default function InviteCode() {
  ...
  if (!household) {
    return (
      <div className="max-w-[700px] mx-auto px-6 py-20 md:py-28 text-center">
        ...
        <p className="text-sm text-zinc-500 mb-10 leading-relaxed max-w-sm mx-auto">
          The code <span className="font-medium text-zinc-700">{inviteCode}</span> didn't
          match any invitation. You can look yourself up by name instead.
        </p>
        <Link
          to="/rsvp"
          className="inline-flex items-center justify-center rounded-[2px] text-xs font-medium tracking-[0.18em] uppercase px-7 py-3 bg-zinc-900 text-zinc-50 transition-all hover:-translate-y-0.5 hover:shadow-md"
        >
          Go to RSVP
        </Link>
      </div>
  ...
  return (
    <div className="max-w-[700px] mx-auto px-6 py-20 md:py-28 text-center">
      ...
      <h1
        className="text-4xl md:text-6xl text-zinc-900 mb-6"
      ...
      <Link
        to="/rsvp"
        className="inline-flex items-center justify-center rounded-[2px] text-xs font-medium tracking-[0.18em] uppercase px-9 py-3.5 bg-zinc-900 text-zinc-50 transition-all hover:-translate-y-0.5 hover:shadow-md"
      >
        Continue to RSVP
      </Link>
    </div>
