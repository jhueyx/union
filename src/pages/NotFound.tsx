...
export default function NotFound() {
  return (
    <div className="max-w-[700px] mx-auto px-6 py-32 text-center min-h-[70vh] flex flex-col items-center justify-center">
      ...
      <Link
        to="/"
        className="inline-flex items-center justify-center rounded-[2px] text-xs font-medium tracking-[0.18em] uppercase px-7 py-3 border border-zinc-200 text-zinc-500 hover:border-zinc-400 hover:text-zinc-900 transition-colors"
      >
        Back Home
      </Link>
    </div>
