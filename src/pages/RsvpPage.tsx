    ...
    <div className="max-w-[700px] mx-auto px-6 py-20 md:py-28">
      ...
      {step === 'lookup' && (
        <div className="max-w-sm mx-auto">
          <h1 className="text-2xl font-[300] tracking-[0.08em] text-zinc-900 mb-3 text-center">
            Find your invitation
          </h1>
          <p className="text-sm text-zinc-500 mb-10 text-center leading-relaxed">
      ...
      {step === 'confirm' && household && (
        <div className="max-w-md mx-auto">
          <h1 className="text-2xl font-[300] tracking-[0.08em] text-zinc-900 mb-2 text-center">
